...
namespace ForgettingCurve.Infrastructure.Migrations
{
    ...
    [Migration("20250501120831_AddEmailVerificationTokens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ForgettingCurve.Domain.Entities.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ForgettingCurve.Domain.Entities.EmailVerificationToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ForgettingCurve.Domain.Entities.EmailVerificationToken", b =>
                {
                    b.HasOne("ForgettingCurve.Domain.Entities.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("ForgettingCurve.Domain.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
